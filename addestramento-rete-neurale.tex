...
Ci sono numerosi metodi per eseguire la DCT ed la relativa data augmentation, in particolare in \cref{fig:dct-algoritmi} sono illustrati due algoritmi, il primo che per ogni frequenza la annulla con propabilità 0.5 e la seconda che la attenua con probabilità \(z\sim U\left(-\frac{1}{2}, \frac{1}{2}\right)\):
